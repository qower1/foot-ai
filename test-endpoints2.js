...
async function run() {
  await testEndpoint('football-get-matches-by-date?date=20240403');
  await testEndpoint('football-get-all-matches-by-date?date=20240403');
  await testEndpoint('football-get-all-matches-by-date?date=2024-04-03');
  await testEndpoint('football-get-matches-by-date?date=20260403');
