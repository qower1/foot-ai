...
async function run() {
  await testEndpoint('football-match-details?matchId=4830708');
  await testEndpoint('football-get-match-details?matchId=4830708');
  await testEndpoint('football-match-info?matchId=4830708');
}
